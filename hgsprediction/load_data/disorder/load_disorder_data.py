...
def load_main_preprocessed_data(population, mri_status, disorder_cohort):
    ...
    file_path = os.path.join(
        folder_path,
        f"primary_preprocess_{disorder_cohort}_data.csv")
...
def load_preprocessed_longitudinal_data(
    ...
    folder_path = os.path.join(
        ...
        "preprocessed_data",
        f"{mri_status}_{population}",
        f"only_longitudinal-{population}_data",
        f"{session_column}_data",  
    )

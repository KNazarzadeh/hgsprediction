...
##############################################################################
    ...
    # df_depression = df_depression.drop(index=1872273)
    ...
    ##############################################################################
        ...
        for gender in ["Female", "Male"]:
            ...
            for k in range(1, n + 1):
                ...
                if gender == "Female":
                    ...
                    corr_female_depression = spearmanr(df_female_depression[f"{target}_predicted"], df_female_depression[f"{target}_true"])[0]
                elif gender == "Male":                
                    ...
                    corr_male_depression = spearmanr(df_male_depression[f"{target}_predicted"], df_male_depression[f"{target}_true"])[0]
            print(matched_data)
            print(matched_pairs)
        ...
        corr_depression = spearmanr(df_both_depression[f"{target}_predicted"], df_both_depression[f"{target}_true"])[0]
        ...
        df_both_depression.rename(columns={f'{target}_true':"true", f"{target}_predicted":"predicted", f"{target}_(true-predicted)": "delta"}, inplace=True)
        if target == "hgs_L+R":
            if depression_cohort == "pre-depression":
...
a = df_anova[["disease", "gender", "predicted", "hgs_target", "depression_cohort"]]
...
g = sns.catplot(
    data=b[b["gender"]=="female"], x="disease_time", y="predicted", hue="hgs_target", col="group",
    capsize=.2, palette=female_palette, errorbar="se",
    kind="point", height=6, aspect=.75,
)
g.despine(left=True)
plt.show()
plt.savefig("anova_predicted_gender_female.png")
plt.figure(figsize=(12, 8))
g = sns.catplot(
    data=b[b["gender"]=="male"], x="disease_time", y="predicted", hue="hgs_target", col="group",
    capsize=.2, palette=male_palette, errorbar="se",
    kind="point", height=6, aspect=.75,
)
g.despine(left=True)
plt.show()
plt.savefig("anova_predicted_gender_male.png")
# Create a point plot
plt.figure(figsize=(12, 8))
g = sns.catplot(
    data=b[b["gender"]=="female"], x="group", y="predicted", hue="hgs_target", col="disease_time",
    capsize=.2, palette=female_palette, errorbar="se",
    kind="point", height=6, aspect=.75,
)
g.despine(left=True)
plt.show()
plt.savefig("anova_group_xaxis_predicted_gender_female.png")

plt.figure(figsize=(12, 8))
g = sns.catplot(
    data=b[b["gender"]=="male"], x="group", y="predicted", hue="hgs_target", col="disease_time",
    capsize=.2, palette=male_palette, errorbar="se",
    kind="point", height=6, aspect=.75,
)
g.despine(left=True)
plt.show()
plt.savefig("anova_predicted_hgs_group_xaxis_gender_male.png")
...
comp = mc.MultiComparison(b["predicted"], interaction_groups)
...
df_healthy_anova = [df_left_pre["predicted"], df_left_post["delta"], df_right_pre["predicted"], df_right_post["predicted"], df_l_r_pre["predicted"], df_l_r_post["predicted"]]
df_depression_anova = [df_left_depression_pre["predicted"], df_left_depression_post["predicted"], df_right_depression_pre["predicted"], df_right_depression_post["predicted"], df_l_r_depression_pre["predicted"], df_l_r_depression_post["predicted"]]
...
###############################################################################
###############################################################################
df_healthy_pre_anova = [df_left_pre["predicted"], df_right_pre["predicted"], df_l_r_pre["predicted"]]
df_healthy_post_anova = [df_left_post["predicted"], df_right_post["predicted"], df_l_r_post["predicted"]]
df_depression_pre_anova = [df_left_depression_pre["predicted"], df_right_depression_pre["predicted"], df_l_r_depression_pre["predicted"]]
df_depression_post_anova = [df_left_depression_post["predicted"], df_right_depression_post["predicted"], df_l_r_depression_post["predicted"]]

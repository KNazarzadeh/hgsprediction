...
def load_main_preprocessed_data(population, mri_status, parkinson_cohort):
...
###############################################################################
# Load preprocessed data
def load_preprocessed_data(population, mri_status, session_column, parkinson_cohort):
    """Get data from the preprocessed csv file.
    Parameters
    ----------
    motor : str
...
def load_preprocessed_longitudinal_data(
    ...
    folder_path = os.path.join(
        ...
        "preprocessed_data",
        f"{mri_status}_{population}",
        "only_longitudinal-parkinson_data",
        f"{session_column}_data",  
    )

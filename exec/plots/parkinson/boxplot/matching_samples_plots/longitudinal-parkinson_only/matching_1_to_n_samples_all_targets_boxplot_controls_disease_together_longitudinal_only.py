...
melted_df = pd.melt(df_main, id_vars=["hgs_target_parkinson_cohort", "disease"], value_vars="delta", var_name="variable", ignore_index=False)
# Initialize a list to store the test results
results = pd.DataFrame(columns=["hgs_target_parkinson_cohort", "ranksum_stat", "ranksum_p_value", "max_sample_delta", "max_parkinson_delta"])
for i, hgs_target_parkinson_cohort in enumerate(["HGS Left-pre", "HGS Left-post", "HGS Right-pre", "HGS Right-post", "HGS L+R-pre", "HGS L+R-post"]):
    ...
    results.loc[i, "max_parkinson_delta"] = tmp_parkinson["value"].max()
...
plt.title(f"Matching samples from controls vs parkinson HGS delta values", fontsize=15, fontweight="bold")
...
melted_df_female = pd.melt(df_main[df_main["gender"]==0], id_vars=["hgs_target_parkinson_cohort", "disease"], value_vars="delta", var_name="variable", ignore_index=False)
results_female = pd.DataFrame(columns=["hgs_target_parkinson_cohort", "ranksum_stat", "ranksum_p_value", "max_sample_delta", "max_parkinson_delta"])
for i, hgs_target_parkinson_cohort in enumerate(["HGS Left-pre", "HGS Left-post", "HGS Right-pre", "HGS Right-post", "HGS L+R-pre", "HGS L+R-post"]):
    ...
    results_female.loc[i, "max_parkinson_delta"] = tmp_parkinson["value"].max()
...
plt.xlabel("HGS targets", fontsize=20, fontweight="bold")
plt.ylabel("HGS delta values", fontsize=20, fontweight="bold")
plt.title(f"Matching samples from controls vs parkinson HGS delta values - Females", fontsize=15, fontweight="bold")
...
melted_df_male = pd.melt(df_main[df_main["gender"]==1], id_vars=["hgs_target_parkinson_cohort", "disease"], value_vars="delta", var_name="variable", ignore_index=False)
results_male = pd.DataFrame(columns=["hgs_target_parkinson_cohort", "ranksum_stat", "ranksum_p_value", "max_sample_delta", "max_parkinson_delta"])
for i, hgs_target_parkinson_cohort in enumerate(["HGS Left-pre", "HGS Left-post", "HGS Right-pre", "HGS Right-post", "HGS L+R-pre", "HGS L+R-post"]):
    ...
    results_male.loc[i, "max_parkinson_delta"] = tmp_parkinson["value"].max()
...
plt.xlabel("HGS targets", fontsize=20, fontweight="bold")
plt.ylabel("HGS delta values", fontsize=20, fontweight="bold")
plt.title(f"Matching samples from controls vs parkinson HGS delta values - Males", fontsize=15, fontweight="bold")

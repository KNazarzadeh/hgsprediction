...
for i in range(2):
    for j in range(5):
        ...
        if i == 0:
            sns.regplot(data=df_female_corrected[df_female_corrected['cv_fold']==fold], x=f"{target}", y=f"{target}_predicted", color=color_female, marker="$\circ$", scatter_kws={'s': 50, 'linewidths': 12}, line_kws={"color": color_female}, ax=ax)
            sns.regplot(data=df_male_corrected[df_male_corrected['cv_fold']==fold], x=f"{target}", y=f"{target}_predicted", color=color_male, marker="$\circ$", scatter_kws={'s': 50, 'linewidths': 12}, line_kws={"color": color_male}, ax=ax)
            ...
            sns.regplot(data=df_female_corrected[df_female_corrected['cv_fold']==fold], x=f"{target}", y=f"hgs_L+R_corrected_predicted", color=color_female, marker="$\circ$", scatter_kws={'s': 50, 'linewidths': 5}, line_kws={"color": color_female}, ax=ax)
            sns.regplot(data=df_male_corrected[df_male_corrected['cv_fold']==fold], x=f"{target}", y=f"hgs_L+R_corrected_predicted", color=color_male, marker="$\circ$", scatter_kws={'s': 50, 'linewidths': 5}, line_kws={"color": color_male}, ax=ax)
...
for i in range(2):
    for j in range(5):
        ...
        if i == 0:
            sns.regplot(data=df_female_corrected[df_female_corrected['cv_fold']==fold], x=f"{target}", y=f"{target}_delta(true-predicted)", color=color_female, marker="$\circ$", scatter_kws={'s': 50, 'linewidths': 12}, line_kws={"color": color_female}, ax=ax)
            sns.regplot(data=df_male_corrected[df_male_corrected['cv_fold']==fold], x=f"{target}", y=f"{target}_delta(true-predicted)", color=color_male, marker="$\circ$", scatter_kws={'s': 50, 'linewidths': 12}, line_kws={"color": color_male}, ax=ax)
            ...
            sns.regplot(data=df_female_corrected[df_female_corrected['cv_fold']==fold], x=f"{target}", y=f"hgs_L+R_corrected_delta(true-predicted)", color=color_female, marker="$\circ$", scatter_kws={'s': 50, 'linewidths': 5}, line_kws={"color": color_female}, ax=ax)
            sns.regplot(data=df_male_corrected[df_male_corrected['cv_fold']==fold], x=f"{target}", y=f"hgs_L+R_corrected_delta(true-predicted)", color=color_male, marker="$\circ$", scatter_kws={'s': 50, 'linewidths': 5}, line_kws={"color": color_male}, ax=ax)

...
ax[0].set_xticks(np.arange(len(top_corr_both_gender)) + bar_width / 2)
ax[0].set_xticklabels(top_corr_both_gender['regions'], rotation=45, ha='right', fontsize=24)

ax[1].set_xticks(np.arange(len(top_corr_male)) + bar_width / 2)
ax[1].set_xticklabels(top_corr_male['regions'], rotation=45, ha='right', fontsize=24)

ax[2].set_xticks(np.arange(len(top_corr_female)) + bar_width / 2)
...
if corr_target == "hgs_corrected_delta":
    ...
    ystep = 0.08
elif corr_target == "hgs_true":
    # Set y-axis limits (you can adjust these values based on your data)
    ymin = 0  # Example minimum value
    ymax = 0.32  # Example maximum value
    ystep = 0.08
...
ax[0].set_ylabel('correlations', fontsize=28)
ax[1].set_ylabel('correlations', fontsize=28)
ax[2].set_ylabel('correlations', fontsize=28)

...
##############################################################################
    ...
    ###############################################################################
    df_post = pd.concat([df_healthy, df_depression], axis=0)
    ...
    for depression_cohort in ["post-depression"]:
        if depression_cohort == "post-depression":
            df = df_post.copy()
...
df_depression_together = df_both_depression_post

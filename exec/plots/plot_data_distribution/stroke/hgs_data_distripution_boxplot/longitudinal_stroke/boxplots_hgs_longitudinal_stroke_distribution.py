...
for yaxis_target in ["(actual-predicted)"]:
    ...
    for group_name, group_columns in column_groups:
        ...
        melted_group['combine_hgs_stroke_cohort_category_gender'] = group_name + '-' + melted_group['stroke_cohort'] + '-' + melted_group['gender']
        # Drop the original 'variable' column
        # melted_group.drop(columns=["gender"], inplace=True)
    ...
    # unique_hgs_categories = melted_df["combine_hgs_gender"].unique()

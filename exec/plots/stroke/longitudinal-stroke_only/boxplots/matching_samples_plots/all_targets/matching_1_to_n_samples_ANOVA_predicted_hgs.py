...
a = df_anova[["disease", "gender", "predicted", "hgs_target", "stroke_cohort"]]
...
df_stroke_anova = [df_left_stroke_pre["predicted"], df_left_stroke_post["predicted"], df_right_stroke_pre["predicted"], df_right_stroke_post["predicted"], df_l_r_stroke_pre["predicted"], df_l_r_stroke_post["predicted"]]
...
df_stroke_pre_anova = [df_left_stroke_pre["predicted"], df_right_stroke_pre["predicted"], df_l_r_stroke_pre["predicted"]]
df_stroke_post_anova = [df_left_stroke_post["predicted"], df_right_stroke_post["predicted"], df_l_r_stroke_post["predicted"]]

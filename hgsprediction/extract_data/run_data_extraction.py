...
def data_extractor(df, mri_status, gender, feature_type, target):
    ...
    if feature_type == "anthropometrics":
        ...
        features = extract_behavioral_features() + extract_gender_features()
        
    elif feature_type == "anthropometrics_behavioral":
        features = extract_anthropometric_features() + extract_behavioral_features()   
    ...
    # save_data_ready_to_predict(df_tmp, )
    return df_tmp

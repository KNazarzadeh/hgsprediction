...
print("Pre Right handed=", len(df[df[f"1st_pre-{population}_hgs_dominant_side"] == "right"]))
print(" %, Pre Right handed=", "{:.2f}".format(len(df[df[f"1st_pre-{population}_hgs_dominant_side"] == "right"])*100/len(df)))


print("Post Right handed=", len(df[df[f"1st_post-{population}_hgs_dominant_side"] == "right"]))
print(" %, Post Right handed=", "{:.2f}".format(len(df[df[f"1st_post-{population}_hgs_dominant_side"] == "right"])*100/len(df)))

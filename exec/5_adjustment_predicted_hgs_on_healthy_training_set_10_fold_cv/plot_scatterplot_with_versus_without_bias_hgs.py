...
# embed(globals(), locals())
###############################################################################
plot_folder = os.path.join(os.getcwd(), f"plots/with_vs_withou_bias_hgs/scatterplot/{target}/{model_name}/{n_repeats}_repeats_{n_folds}_folds/{correlation_type}/on_9_folds_training_last_fold_testing/")
...
ax[0, 1].annotate(r_text_female_01, xy=(0.322, 0.87), xycoords='axes fraction', fontsize=10, color=color_female, bbox=dict(boxstyle='square,pad=0.3', edgecolor='lightgrey', facecolor='none'))

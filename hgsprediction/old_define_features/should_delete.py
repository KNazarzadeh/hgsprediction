...
###############################################################################
    ...
    def features_extractor(self, df):
        ...
        if feature_type == "anthropometrics":
            result = self.extract_anthropometric_features()
                
        elif feature_type == "anthropometrics_gender":
            result = self.extract_anthropometric_features() + self.extract_gender_features()

        elif feature_type == "anthropometrics_age":
            result = self.extract_anthropometric_features() + self.extract_age_features()
            
        elif feature_type == "behavioral":
            result = self.extract_behavioral_features()
            
        elif feature_type == "behavioral_gender":
            result = self.extract_behavioral_features() + self.extract_gender_features()
            
        elif feature_type == "anthropometrics_behavioral":
            result = self.extract_anthropometric_features() + self.extract_behavioral_features()   
                        
        elif feature_type == "anthropometrics_behavioral_gender":
            result = self.extract_anthropometric_features() + self.extract_behavioral_features() + self.extract_gender_features()
...
###############################################################################
    ...
    def extract_anthropometric_features(self):

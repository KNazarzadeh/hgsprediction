...
df_female = load_disorder_data.load_extracted_data_by_feature_and_target(
        population,
        mri_status,
        session_column,
        feature_type,
...
df_male = load_disorder_data.load_extracted_data_by_feature_and_target(
        population,
        mri_status,
        session_column,
        feature_type,

...
both_gender_right_handed = len(df_both_gender[df_both_gender[f'handedness-{session}.0']==1.0])

print("\n '%' of both gender Right dominant hand =", "{:.2f}".format(both_gender_right_handed*100/len(df_both_gender)))
###############################################################################

...
for model_name in ["linear_svm", "random_forest"]:
    ...
    for samplesize in samplesize_list:
        ...
        df_tmp = pd.concat ([df_tmp_female[['test_pearson_corr', 'samplesize_percent', 'gender']], df_tmp_male[['test_pearson_corr', 'samplesize_percent', 'gender']]], axis=0)
...
ax = sns.violinplot(data=df_combined_models_scores, x="model_sample", y="test_pearson_corr", hue='gender', palette=custom_palette, linewidth=7, inner="box")
...
ax = sns.set_style("whitegrid")
ax = sns.boxplot(data=df_combined_models_scores, x="model_sample", y="test_pearson_corr", hue='gender', palette=custom_palette, linewidth=2, boxprops=dict(alpha=.5))
